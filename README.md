...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ads-async-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11858&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ads-async-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ads-async` can be installed with:

```
conda install ads-async
```

It is possible to list all of the versions of `ads-async` available on your platform with:
